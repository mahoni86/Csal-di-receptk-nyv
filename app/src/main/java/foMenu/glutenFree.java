...
public class glutenFree extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.main), (v, insets) -> {
            ...
            TextView glutenFree = findViewById(R.id.glutenFree);
            ObjectAnimator animator = ObjectAnimator.ofFloat(glutenFree, "translationY", 600f, 10f);//animáció
            ...
            animator.addListener(new android.animation.Animator.AnimatorListener() {
                ...
                public void onAnimationEnd(android.animation.Animator animation) {
                    ...
                    glutenFree.setTranslationY(10f);
                }
        ...
        addButton.setOnClickListener(v -> {
            Intent intent = new Intent(glutenFree.this, ujRecept.class);
            intent.putExtra("kategoria", "glutenFree");
            startActivity(intent);
        });

        adapter = new ReceptAdapter_2(receptLista, recept -> {

            Intent intent = new Intent(glutenFree.this, ReceptReading.class);
    ...
    private void loadReceptek() {
        db.collection("receptek")
                .whereEqualTo("kategoria", "glutenFree")
                .get()
