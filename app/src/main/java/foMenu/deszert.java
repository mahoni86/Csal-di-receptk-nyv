...
public class deszert extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addButton.setOnClickListener(v -> {
            Intent intent = new Intent(deszert.this, ujRecept.class);
            intent.putExtra("kategoria", "deszert");
            startActivity(intent);
        });

        adapter = new ReceptAdapter_2(receptLista, recept -> {

            Intent intent = new Intent(deszert.this, ReceptReading.class);
    ...
    private void loadReceptek() {
        db.collection("receptek")
                .whereEqualTo("kategoria", "deszert")
                .get()
